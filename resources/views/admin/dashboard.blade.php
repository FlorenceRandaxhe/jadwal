...
@section('content')
    ...
    <section class="section__admin section">
        <div class="wrapper">
            <div class="dashboard__header">
                <h2 class="dashboard__title">Dashboard</h2>

               {{-- <a class="btn btn--dark-purple" href="/sessions/create">Créer une nouvelle session</a>--}}
            </div>
           {{-- <a class="" href="/teachers">Voir ma liste de professeurs</a>--}}
            ...
            <section class="card__sessions">
                ...
                <ul class="card__sessions__list">
                    ...
                    <li class="box__container card__session__dashboard">
